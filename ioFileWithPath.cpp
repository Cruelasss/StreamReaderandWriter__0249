...
int main(){
    //deklarasi variabel baris untuk menyimpan data string dan NamaFile untuk menyimpan nama file yang akan dibuat
  ...
  ofstream outfile;
//menunjuk ke sebuah nama file dengan ekstensi .txt dan mode output
